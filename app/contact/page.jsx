...
const ErrorTooltip = ({ message }) => (
  <span className="absolute bottom-full mb-1 left-2 z-10 bg-red-500 text-white text-[10px] font-semibold px-2 py-0.5 rounded-md shadow-lg pointer-events-none select-none">
    {message}
  </span>
);
